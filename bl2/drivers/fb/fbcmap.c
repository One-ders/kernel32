...
static unsigned short int red2[] = {
	0x0000, 0xaaaa
};
static unsigned short int green2[] = {
	0x0000, 0xaaaa
};
static unsigned short int blue2[] = {
	0x0000, 0xaaaa
};

static unsigned short int red4[] = {
	0x0000, 0xaaaa, 0x5555, 0xffff
};
static unsigned short int green4[] = {
	0x0000, 0xaaaa, 0x5555, 0xffff
};
static unsigned short int blue4[] = {
	0x0000, 0xaaaa, 0x5555, 0xffff
};

static unsigned short int red8[] = {
	0x0000, 0x0000, 0x0000, 0x0000, 0xaaaa, 0xaaaa, 0xaaaa, 0xaaaa
};
static unsigned short int green8[] = {
	0x0000, 0x0000, 0xaaaa, 0xaaaa, 0x0000, 0x0000, 0x5555, 0xaaaa
};
static unsigned short int blue8[] = {
	0x0000, 0xaaaa, 0x0000, 0xaaaa, 0x0000, 0xaaaa, 0x0000, 0xaaaa
};

static unsigned short int red16[] = {
	0x0000, 0x0000, 0x0000, 0x0000, 0xaaaa, 0xaaaa, 0xaaaa, 0xaaaa,
	0x5555, 0x5555, 0x5555, 0x5555, 0xffff, 0xffff, 0xffff, 0xffff
};
static unsigned short int green16[] = {
	0x0000, 0x0000, 0xaaaa, 0xaaaa, 0x0000, 0x0000, 0x5555, 0xaaaa,
	0x5555, 0x5555, 0xffff, 0xffff, 0x5555, 0x5555, 0xffff, 0xffff
};
static unsigned short int blue16[] = {
	0x0000, 0xaaaa, 0x0000, 0xaaaa, 0x0000, 0xaaaa, 0x0000, 0xaaaa,
...
int fb_set_cmap(struct fb_cmap *cmap, struct fb_info *info) {
	int i, start, rc = 0;
	unsigned short int *red, *green, *blue, *transp;
	...
	if (rc == 0) fb_copy_cmap(cmap, &info->cmap);

	return rc;
}

int fb_set_user_cmap(struct fb_cmap_user *cmap, struct fb_info *info) {
	int rc, size = cmap->len * sizeof(unsigned short int);
	struct fb_cmap umap;
...
const struct fb_cmap *fb_default_cmap(int len) {
	if (len <= 2) return &default_2_colors;
	if (len <= 4) return &default_4_colors;
	if (len <= 8) return &default_8_colors;
